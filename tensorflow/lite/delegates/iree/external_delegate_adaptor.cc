...
TfLiteDelegate* CreateIreeDelegateFromOptions(
  ...
  constexpr char kIreeDelegateParsing[] = "iree_delegate_parsing";
  argv.push_back(kIreeDelegateParsing);
  ...
  TFLITE_LOG(INFO) << "Iree delegate: allowed_builtin_code set to "
                   << options.allowed_builtin_code << ".";
  TFLITE_LOG(INFO) << "Iree delegate: error_during_init set to "
                   << options.error_during_init << ".";
  TFLITE_LOG(INFO) << "Iree delegate: error_during_prepare set to "
                   << options.error_during_prepare << ".";
  TFLITE_LOG(INFO) << "Iree delegate: error_during_invoke set to "
                   << options.error_during_invoke << ".";

  return TfLiteIreeDelegateCreate(&options);
}
...
tflite_plugin_create_delegate(const char* const* options_keys,
  ...
  return tflite::tools::CreateIreeDelegateFromOptions(
